        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header" STYLE="background-color: #f44336 !important;color: white !important;">
                    <h4 class="modal-title">Vous avez dépassez deux heures <svg class="bi bi-emoji-frown" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
