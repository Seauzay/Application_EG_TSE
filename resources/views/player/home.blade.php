    ...
    <template id="player-riddle-template">
        <div class="card player-riddle-card my-2">
            <div class="card-body">
                ...
                <a class="card-link player-riddle-url " target="_blank" style="display: none; color: #182949 !important "><span><svg class="bi bi-link" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
